...
<html>
<head>
    <title>Welcome to the Kittens Project</title>
...
<div class="container mt-4">
    <h1>Welcome to the Kittens Project</h1>
    <p>This is the home page with information about our project dedicated to kittens.</p>
    <div class="card mb-3">
        <div class="card-body">
